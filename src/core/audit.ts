...
export const AUDIT_ACTIONS = {
  ...
  connectResume: "connect.resume",
  connectClearError: "connect.clear_error",
...
export const WRITE_HTTP_ROUTES = [
  ...
  { method: "DELETE", path: "/api/v1/connect", action: AUDIT_ACTIONS.connectDisconnect },
  { method: "PATCH", path: "/api/v1/connect", action: AUDIT_ACTIONS.connectPause },
  { method: "PATCH", path: "/api/v1/connect", action: AUDIT_ACTIONS.connectResume },
  { method: "PATCH", path: "/api/v1/connect", action: AUDIT_ACTIONS.connectClearError },
